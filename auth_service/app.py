...
if __name__ == '__main__':
    # Wait for DB to be ready is handled by restart policy or wait-for scripting usually, 
    # but we will rely on retry or manual delay for MVP. 
    # We attempt to create tables on start.
    try:
        init_db()
    except Exception as e:
        print(f"Error creating DB tables (might be connection issue, will retry if container restarts): {e}")
